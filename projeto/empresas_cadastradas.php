...
<body>
    <div class="container">
        <?php include_once("modal_update_empresa.php"); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 mt-5 p-3 border rounded">
                ...
                <h2 class="text-center text-secondary mb-3">Empresas Cadastradas</h2>

                <div class="row mb-3">
                    <div class="col-12 col-sm-6">
                        <input type="text" id="pesquisaEmpresa" class="form-control" placeholder="Digite o nome da empresa que deseja pesquisar">
                    </div>
                    <div class="col-12 col-sm-6">
