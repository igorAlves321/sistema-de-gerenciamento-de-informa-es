...
<h2> A qui você vai poder alterar seus dados</h2>
        ...
        <div class="mb-3 mt-3">
            ...
            <input type="text" class="form-control" idproduto="nome" 
                                        placeholder="Digite seu nome">
        </div>
        <div class="mb-3 mt-3">
            <label for="telefone" class="form-label">Telefone:</label>
            <input type="text" class="form-control" idproduto="descricao" placeholder="Digite uma descriçção para o produto">
        </div>
        <select id="tipoEmpresa"> 
        </select>
        <button  type="button" class="btn btn-info" idproduto="btnAlterar">Alterar</button>
