...
<body>
    <div class="container-fluid">
        ...
        <h2> Aqui você vai poder alterar os tipos de produto</h2>
        <input type="hidden" id="idtipoproduto" value="<?php echo $_GET["id"];?>" /> <!-- Atualizado o id para 'idtipoproduto' -->
...
<script src="js/telaalterartipoproduto.js"></script>
</html>
