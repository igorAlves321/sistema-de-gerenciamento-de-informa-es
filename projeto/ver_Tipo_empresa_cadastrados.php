...
<head>
    ...
    <title>Tipos de Empresa Cadastrados</title>
</head>

<body>
    <div class="container">
        <?php include_once("modal_update_tipo_empresa.php"); ?>
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 mt-5 p-3 border rounded">
                ...
                <h2 class="text-center text-secondary mb-3">Tipos de Empresa Cadastrados</h2>

                <div class="row mb-3">
                    <div class="col-12 col-sm-6">
                        <input type="text" id="pesquisaTipoEmpresa" class="form-control" placeholder="Digite o nome do tipo que deseja pesquisar">
                    </div>
                    <div class="col-12 col-sm-6">
                ...
                <table id="tabelaTiposEmpresa" class="table">
                    <thead>
                        <tr>
                            <th>Nome do Tipo</th>
                            <th>Opções</th>
