    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-12 col-md-8 mt-5 p-3 border rounded">
                ...
                <h2 class="text-center text-secondary mb-3">Produtos Cadastrados</h2>

                <div class="row mb-3">
                    <div class="col-12 col-sm-6">
                        <input type="text" id="pesquisaProduto" class="form-control" placeholder="Digite o nome do produto">
                    </div>
                    <div class="col-12 col-sm-6">
